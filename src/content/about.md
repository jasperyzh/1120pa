...
This website is a collection of information gathered over the years living at **1120 Park Avenue**. Much of this info was originally buried in WhatsApp chatgroups or posted on physical notice boards. We decided to gather it all in one place to make daily life a little easier for everyone.

### 📢 The "Neighborly" Disclaimer
**This is an unofficial project.**
We are **not** the Management Office (MO), the Joint Management Body (JMB), or the Management Corporation (MC).

While we try our best to keep things accurate, rules and fees can change. **For critical matters—like paying maintenance fees, official complaints, or checking legal notices—please always refer to the official management office or their designated app.**

---

### 🛠 What is this place?
Think of this as an "Un-Official Quick Start Guide" to the building.
...
### ⚖️ Terms of Use
1.  **"As-Is" Basis:** This site is a volunteer effort. We aren't responsible if a facility booking time changes or a phone number is outdated (though we try to fix mistakes fast!).
2.  **Community Spirit:** This is a neutral platform meant to help, not to complain. Let’s keep it positive.
3.  **Copyright:** Any photos or branding related to the building remain the property of their respective owners.
...
This project works best when we help each other. If you have updated info or a suggestion, drop it in the feedback form!